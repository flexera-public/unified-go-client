...
#
# The unified-openapi snapshot is consumed at its checked-in pinned revision.
# This script never fetches upstream specs or regenerates unified-openapi/openapi3.json.
set -euo pipefail

SCRIPT_DIR="$(cd "$(dirname "${BASH_SOURCE[0]}")" && pwd)"
SPEC_FILE="$SCRIPT_DIR/unified-openapi/openapi3.json"
SPEC_CONFIG="$SCRIPT_DIR/unified-openapi/specs.yaml"
